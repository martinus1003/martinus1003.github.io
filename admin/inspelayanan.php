 <?php 
  ...
  if(!isset($_SESSION['admin_id'])) {
	...
	if(isset($_POST['Simpan'])) {
		...
		$jnspelayanan = $_REQUEST["inputanjnspel"];
		mysqli_query($connection, "INSERT INTO pelayanan VALUES ('', '$jnspelayanan')");
...
<html>
  <head>
    ...
    <title>Yatta Corporation | Tambah Pelayanan</title>
			...
			<section class="forms">
				  ...
				  <div class="container-fluid">
					  ...
					  <div class="form-group row">
						<label for="jns_pelayanan" class="col-sm-3 col-form-label">Jenis Pelayanan</label>
						<div class="col-sm-6">
						  <input type="text" class="form-control" id="jns_pelayanan" name="inputanjnspel" placeholder="Inputkan Jenis Pelayanan" required="">
						</div>
					  </div>
