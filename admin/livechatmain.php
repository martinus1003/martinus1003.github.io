...
<html>
  <head>
    ...
    <title>Yatta Corporation | Home Dashboard Admin</title>
  ...
  <body>
    ...
    <div class="page">
	  ...
	  <div style="overflow:auto; width:30%; height:320px; margin-left:5%;margin-right:35%; margin-top:5%;">
  <table class="art-article" border="0" cellspacing="0" cellpadding="0" style=" margin: 0; width: 100%;">
    <tbody>
      ...
      $Tampil="SELECT * FROM chat WHERE send_to = '$namacust' OR nama = '$namacust' ORDER BY waktu ASC LIMIT 99";
...
<div style="width:30%; height:320px; margin-left:5%;margin-right:35%;">
  ...
  <?php
    ...
    $input_chat = "INSERT INTO chat (nama, komen, waktu, send_to) VALUES ('Administrator', '$komen', curtime(), '$namacust')";
    $query_input =mysqli_query($connection, $input_chat);

    header("livechatmain.php?custname=$namacust"); 
