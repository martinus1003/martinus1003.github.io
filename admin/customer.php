...
<html>
  <head>
    ...
    <title>Yatta Corporation | Customer</title>
      ...
      <div class="breadcrumb-holder">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Header-->
           ...
           <button type="button" class="btn btn-info" style="margin-bottom: 16px; margin-left: 15px; margin-top: 20px" onclick="window.location.href='inscustomer.php'"><b>+</b> Tambah Customer</button>
           ...
           <button type="button" class="btn btn-info" style="margin-left: 10px" onclick="window.location.href='customer.php'"> Reset Pencarian</button>
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        ...
                        <?php if(mysqli_num_rows($query) > 0)  { ?>
                                ...
                                if(isset($_GET['Search'])){
                                    $Search = $_GET['Search'];
                                    $query = mysqli_query($connection,"select * from customer where nama_cust like '%$Search%' 
                        ...
                        <tr>
                          ...
                          <td>
                                <a href="updatedeletecustomer.php?idcust=<?php echo $row['cust_id']?>"> Update </a> |
                                <a href="updatedeletecustomer.php?idcusthapus=<?php echo $row['cust_id']?>" onclick="return confirm ('Jika Anda menghapus Data ini, maka semua Data di tabel lain yang terhubung dengan Data ini akan ikut terhapus. Apakah Anda Yakin?')"> Delete </a>
                              </td>
                        </tr>
