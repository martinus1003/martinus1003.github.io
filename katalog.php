...
<html lang="en">
  <head>
    <title>Yatta Corporation | Our Product</title>
    <meta charset="utf-8">
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="shop-single.php?kdproduk=<?php echo $row["id_produk"]?>"><img src="images/baju/<?php echo $row["head_img"]?>" alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.php?kdproduk=<?php echo $row["id_produk"]?>"><?php echo $row["nm_produk"] ?></a></h3>
                    
                    <p class="text-primary font-weight-bold">Rp. <?php echo $harga ?></p>
                  </div>
                </div>
              </div>
                  <?php } ?>
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
                    <a class="block-2-item" href="#">
                      ...
                      <div class="text">
                        ...
                        <h3><?php echo $row["nm_kategori"] ?></h3>
                      </div>
                    </a>
                  </div>
                                     <?php } ?>
